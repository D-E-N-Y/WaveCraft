/*
	Screen-Spaced Depth Based Outline Shader written by The Developer
...
Shader "The Developer/SS Depth Based Outline"
{
	Properties
	{
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            #define PSL01UVC(tex, uv1, uv2) pow(\
                (SAMPLE_DEPTH_TEXTURE(tex, uv1) - SAMPLE_DEPTH_TEXTURE(tex, uv2)) * _DepthMultiplier, \
                2)
